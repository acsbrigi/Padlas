...
<form id="createNewProductForm" class = "container text-center searchform" action="<?php echo $_SERVER["PHP_SELF"]?>" method="POST">
    <fieldset>
        <legend><h3>Új termék létrehozása</h3></legend>
        ...
        <input class="btn btn-secondary text-center" type="submit" value="Termék létrehozása">
        <input class="btn btn-secondary text-center" type="submit" value="Létrehozás megszakítása">
    </fieldset>
</form>
